  ...
  try {
    ...
    return NextResponse.json({
      farmer: {
        ...
        disbursementAccountNo: farmer.disbursementAccountNo,
        disbursementAccountName: farmer.disbursementAccountName,
        disbursementAccountSelectedAt: farmer.disbursementAccountSelectedAt,
